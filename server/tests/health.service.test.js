...
process.env.MINIO_PRESIGNED_URL_EXPIRY_SECONDS = '3600';
process.env.MINIO_CORS_ALLOWED_ORIGINS = 'http://localhost:5173';
...
process.env.EMAIL_SMTP_PASSWORD = 'password';
process.env.EMAIL_FROM_ADDRESS = 'no-reply@test.dev';
