    ...
    schemas: {
      ...
      AuditLog: {
        ...
        properties: {
          ...
          performedById: { type: 'string', nullable: true },
          performedBy: { $ref: '#/components/schemas/AuthUser', nullable: true },
          affectedUserId: { type: 'string', nullable: true },
          affectedUser: { $ref: '#/components/schemas/AuthUser', nullable: true },
