...
export function UnauthorizedPage() {
  return (
    <StatusLayout>
      ...
      >
        <p>
          Please sign in with your credentials to continue. If you believe this is a mistake, try logging in again or contact your workspace administrator to restore access.
        </p>
      </StatusPage>
    </StatusLayout>
  );
