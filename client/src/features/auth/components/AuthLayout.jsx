    ...
    <div className="flex min-h-dvh flex-col lg:flex-row">
      <div className="relative hidden w-full flex-1 flex-col justify-between overflow-hidden bg-secondary p-10 text-primary-foreground lg:flex">
        <div className="relative z-10">
          <p className="text-sm uppercase tracking-[0.3rem] opacity-80">AI Governance Platform</p>
          <h1 className="mt-6 text-4xl font-semibold leading-tight text-primary-foreground">Secure identity, resilient governance.</h1>
