...
export function AuthLayout() {
  return (
    <div className="flex h-dvh flex-col lg:flex-row overflow-hidden">
      ...
      <div className="relative hidden w-full flex-1 flex-col justify-between overflow-hidden bg-secondary p-10 text-secondary-foreground lg:flex">
      ...
      <div className="flex w-full flex-1 min-h-0 flex-col bg-background text-foreground overflow-hidden">
