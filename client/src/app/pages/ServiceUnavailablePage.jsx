...
export function ServiceUnavailablePage() {
  return (
    ...
    >
      <p>
        We expect to restore full service shortly. Check our status page for live updates or
        contact support if you need help with urgent compliance tasks.
      </p>
      <p className="text-sm text-muted-foreground">
        Estimated time to resolution: <Clock className="mr-1 inline size-4 align-text-bottom" aria-hidden="true" />
