...
- WebSocket subscriptions use `/ws/audit/stream` with token re-auth every 30 minutes; reconnect logic abides by exponential backoff policies shared across observability features.
